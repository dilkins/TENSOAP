...
The Python packages :code:`ase`, :code:`scipy`, :code:`sympy` and :code:`cython` are required to run the SA-GPR code. :code:`numpy` version 1.16.2 or below is required (to avoid a problem with loading arrays of objects).

Installation
============

This program is installed using a makefile, found in the :code:`soapfast` subdirectory. To install the python packages needed for soapfast, the command :code:`make python` is used. To compile the cython code needed for kernel building, :code:`make cython` is used, and to run both of these, either :code:`make all` or simple :code:`make` should be used. To remove the cython object files, run :code:`make clean`.
...
::
  ...
  $ sagpr_get_kernel -lm 0 -z 2 -ps PS0.npy -s PS0_natoms.npy -o kernel0
...
::
  ...
  $ sagpr_get_kernel -lm 2 -z 2 -ps PS2.npy -ps0 PS0.npy -s PS2_natoms.npy -o kernel2
...
::
  ...
  $ sagpr_get_kernel -lm 1 -z 2 -ps PS1.npy -ps0 PS0.npy -s PS0_natoms.npy -o kernel1
...
::
  ...
  $ >>> for i in xrange(len(ter)):
  $ ...     dipole = xyz[ter[i]].info["mu"]
  $ ...     print >> corrfile, ' '.join(str(e) for e in list(dipole))
  $ ...
...
::
  ...
  $ sagpr_get_kernel -ps PS0.npy -z 2 -lm 0 -s PS0_natoms.npy -o kernel0
...
::
  ...
  $ sagpr_get_kernel -lm 2 -z 2 -ps PS2_sparse.npy -ps0 PS0.npy -s PS2_sparse_natoms.npy -o kernel2
...
::
  ...
  $ sagpr_get_kernel -ps PS0.npy PS0_full_sparsified_atomic.npy -s PS0_natoms.npy NONE -lm 0 -z 2 -o KERNEL_L0_NM
  $ sagpr_get_kernel -ps PS0_full_sparsified_atomic.npy -s NONE -lm 0 -z 2 -o KERNEL_L0_MM
  $ sagpr_get_kernel -ps PS2.npy PS2_full_sparsified_atomic.npy -ps0 PS0.npy PS0_full_sparsified_atomic.npy -s PS2_natoms.npy NONE -lm 2 -z 2 -o KERNEL_L2_NM
  $ sagpr_get_kernel -ps PS2_full_sparsified_atomic.npy -ps0 PS0_full_sparsified_atomic.npy -s NONE -lm 2 -z 2 -o KERNEL_L2_MM
...
::
  ...
  $ sagpr_get_kernel -lm 0 -z 2 -ps PS0_ice.npy PS0_full_sparsified_atomic.npy -s PS0_ice_natoms.npy NONE -o KERNEL_L0_ice_train
  $ sagpr_get_kernel -lm 2 -z 2 -ps PS2_ice.npy PS2_full_sparsified_atomic.npy -ps0 PS0_ice.npy PS0_full_sparsified_atomic.npy -s PS0_ice_natoms.npy NONE -o KERNEL_L2_ice_train
...
::
  ...
  $ for atom in O H;do sagpr_get_kernel -ps PS0_atomic_${atom}.npy -s NONE -lm 0 -z 2 -o KER0_atomic_${atom} & done
...
::
  ...
  $ for lm in 0 1 2;do sagpr_get_kernel -lm ${lm} -z 2 -ps PS${lm}.npy -ps0 PS0.npy -s PS0_natoms.npy -o KER${lm};done 
...
Note that the relative error in learning the L=0 component is very large (around 100%); this is simply because these coordinates were produced by applying random rigid-body rotations to the molecule. For the same reason, the L=1 and L=2 components are learning with 0% error. Rather than comparing these numbers, we can check on the quality of the prediction by using the :code:`prediction_cartesian.txt` output file:
...
::
  ...
  $ for lm in 0 2 4;do sagpr_get_kernel -z 2 -ps PS${lm}.npy -ps0 PS0.npy -s PS${lm}_natoms.npy -lm ${lm} -o KER${lm} & done
...
::
  ...
  $ sagpr_get_kernel -lm 0 -z 2 -ps PS0_train.npy -s PS0_train_natoms.npy -o K0
  $ sagpr_get_kernel -lm 0 -z 2 -ps PS0_test.npy PS0_train.npy -s PS0_test_natoms.npy PS0_train_natoms.npy -o K0_TT
...
::
  ...
  $ for env in 1000 2000 5000;do sagpr_get_kernel -lm 0 -z 2 -ps PS0_train.npy PS0_train_atomic_${env}.npy -s PS0_train_natoms.npy NONE -o K0_NM_${env};done
  $ for env in 1000 2000 5000;do sagpr_get_kernel -lm 0 -z 2 -ps PS0_train_atomic_${env}.npy -s NONE -o K0_MM_${env};done
  $ for env in 1000 2000 5000;do sagpr_get_kernel -lm 0 -z 2 -ps PS0_test.npy PS0_train_atomic_${env}.npy -s PS0_test_natoms.npy NONE -o K0_TT_${env};done
...
Andrea Grisafi, David Wilkins, Edoardo Baldi, Andrea Anelli, Michele Ceriotti
