...
# build L=0 kernel
sagpr_get_kernel -lm 0 -z 1 -ps PS0.npy -o KER0_zeta1 -s PS0_natoms.npy > /dev/null
sagpr_get_kernel -lm 0 -z 2 -ps PS0.npy -o KER0 -s PS0_natoms.npy > /dev/null

# build L=2 kernel
sagpr_get_kernel -lm 2 -z 1 -ps PS2.npy -ps0 PS0.npy -o KER2_zeta1 -s PS2_natoms.npy > /dev/null
